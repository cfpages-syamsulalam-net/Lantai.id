---
article_id: LNT-09-03
title: "Epoxy Flake, 3D, dan Decorative Resin Floor"
slug: "decorative-resin-floor"
description: "Compare look, sample control, texture, UV, repair visibility, and care"
status: outline
publication_date: "2025-06-27"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LNT-09
primary_intent: "Compare decorative resin"
reader_community: "Lantai.id"
reader_address: "Kawan Lantai.id"
final_route: "/artikel/decorative-resin-floor.html"
...
# Epoxy Flake, 3D, dan Decorative Resin Floor

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Epoxy Flake, 3D, dan Decorative Resin Floor”
- **Reader and situation:** Retail/home designer
- **Reader outcome:** Compare look, sample control, texture, UV, repair visibility, and care
- **Primary intent:** Compare decorative resin
...
- **Scope boundary:** Excludes direct 3D route `/epoxy/3d`
- **Final public route:** `/artikel/decorative-resin-floor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Epoxy Flake, 3D, dan Decorative Resin Floor**.
...
- **Exact Markdown to insert:** `![Ilustrasi Epoxy Flake](/wp-content/uploads/2023/07/Epoxy-Flake.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Epoxy Flake` as relevant content media; no pixels were inspected.
...
- `/epoxy/flake` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/epoxy/flake/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Epoxy Flake, 3D, dan Decorative Resin Floor”.
